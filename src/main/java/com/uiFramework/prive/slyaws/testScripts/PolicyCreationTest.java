...
public class PolicyCreationTest extends TestBase {
	
	LoginPage login ;
	AccountContactCreationPage account;
	PolicyCreationPage policycreate;

	private final Logger log = Logger.getLogger(PolicyCreationTest.class);
	
	@DataProvider(name = "testData")
	public Object[][] testData() {
		Object[][] data = getExcelData("testData.xlsx", "Policy_Data_Node1");
		return data;
	}
